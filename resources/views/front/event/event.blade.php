                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="single-event mb-60">
                                <div class="event-img">
                                    <a href="#">
                                        <img src="{{asset('front')}}/img/event/event.jpg" alt="event">
                                ...
                                <div class="event-content text-left">
                                    <h4><a href="#">ADVANCE PHP WORKSHOP</a></h4>
                                    <ul>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="single-event mb-60">
                                ...
                                <div class="event-content text-left">
                                    <h4><a href="#">learning english history</a></h4>
                                    <ul>
                                        <li><span>time:</span> 9.00 AM - 4.45 PM</li>
                                        <li><span>venue</span> Kathmandu</li>
                                    </ul>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="single-event mb-60">
                                ...
                                <div class="event-content text-left">
                                    <h4><a href="#">ADVANCE WEB DEVELOPMENT</a></h4>
                                    <ul>
                                        <li><span>time:</span> 9.00 AM - 4.45 PM</li>
                                        <li><span>venue</span> Kathmandu</li>
                                    </ul>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="single-event mb-60">
                                ...
                                <div class="event-content text-left">
                                    <h4><a href="#">digital marketing analysis</a></h4>
                                    <ul>
                                        <li><span>time:</span> 9.00 AM - 4.45 PM</li>
                                        <li><span>venue</span> Kathmandu</li>
                                    </ul>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="single-event mb-60">
                                ...
                                <div class="event-content text-left">
                                    <h4><a href="#">Developer's meetup</a></h4>
                                    <ul>
                                        <li><span>time:</span> 9.00 AM - 4.45 PM</li>
                                        <li><span>venue</span> Kathmandu</li>
                                    </ul>
